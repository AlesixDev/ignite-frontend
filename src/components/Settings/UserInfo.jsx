    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-4 rounded-lg border border-gray-800 bg-gray-950/40 p-4">
        <div>
          ...
          <div className="mt-1 text-sm text-gray-200">{user?.username || 'Unknown'}</div>
        </div>
        <div>
          <div className="text-xs uppercase tracking-wide text-gray-500">Status</div>
          <div className="mt-1 text-sm text-gray-300">{user?.status || 'Online'}</div>
        </div>
        <div>
          <div className="text-xs uppercase tracking-wide text-gray-500">Email</div>
          <div className="mt-1 text-sm text-gray-300">Placeholder for account email.</div>
        </div>
      </div>
    </div>
  );
