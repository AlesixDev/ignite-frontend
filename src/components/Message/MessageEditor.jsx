    ...
    return (
        <div className="my-2 w-full">
            ...
            <p className="text-xs text-gray-400">
                escape to <button onClick={onCancel} className="text-primary hover:underline">cancel</button> •
                enter to <button onClick={handleSubmit} className="text-primary hover:underline">save</button>
            </p>
        </div>
    );
};
