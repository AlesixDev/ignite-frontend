    ...
    <div className="space-y-6">
      ...
      <div className="rounded-lg border border-gray-800 bg-gray-950/40 p-4">
        ...
        <div className="space-y-2 text-sm text-gray-300">
          <div className="rounded bg-gray-900/60 px-3 py-2">Admin (placeholder)</div>
          <div className="rounded bg-gray-900/60 px-3 py-2">Moderator (placeholder)</div>
          <div className="rounded bg-gray-900/60 px-3 py-2">Member (placeholder)</div>
        </div>
      </div>
    </div>
  );
